...
## SEO
gem 'meta-tags', '>= 1.2.6', :require => 'meta_tags' # Search Engine Optimization (SEO) plugin for Ruby on Rails applications.

## Performance and optimization
gem 'delayed_job_active_record'           , '>= 4.1.3' # Lets you queue tasks as background jobs
...
gem 'devise', '~> 4.4', '>= 4.4.2' # User authentication
...
gem 'paperclip', '~> 3.4', '>= 3.4.0' # Easy file attachment library for ActiveRecord
gem 'aws-sdk', '~> 1.3.4'                 # Upload files to Amazon S3

## Gems used only for assets and not required
## in production environments by default.
group :assets do
  gem 'sass-rails', '~> 5.0.5' # Rails support for Sass, a CSS extension language
...
group :test, :development do
  gem 'foreman'
  gem 'rspec-rails', '>= 2.14.0' # Testing framework
  gem 'shoulda', '~> 3.5.0' # Extra RSpec matchers for Active Record Associations
  gem 'factory_girl_rails', '~> 4.2', '>= 4.2.1' # Create factories to test against
  gem 'capybara', '~> 2.1'
  gem 'guard', '~> 1.8.0'
