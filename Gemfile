...
gem 'devise', '~> 3.0', '>= 3.0.0' # User authentication
...
gem 'json'                                , '>= 2.3.0' # Convert between JSON and Ruby objects
...
gem 'aws-sdk', '~> 1.52.0' # Upload files to Amazon S3

## Gems used only for assets and not required
## in production environments by default.
group :assets do
  gem 'sass-rails', '~> 4.0.0' # Rails support for Sass, a CSS extension language
